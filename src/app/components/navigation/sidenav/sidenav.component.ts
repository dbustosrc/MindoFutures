...
import {DocumentationItemsComponent} from '../documentation-items/documentation-items.component';
...
export class SidenavComponent implements OnInit {
  ...
  constructor(public docItems: DocumentationItemsComponent,
...
@NgModule({
  ...
  providers: [DocumentationItemsComponent],
})
